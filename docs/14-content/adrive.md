...
> 提取自 prod-assets/pages/adrive.html（SSR HTML）。`<title>`: aDrive 阿里云盘

## 标题区（article header, `pt-[10vh]`）

- **H1 标题**: aDrive 阿里云盘
- **日期行**（`mt-1 tabular-nums text-l2!`）: Jan 07, 2022
- **描述/年份行**: （此页无）
...
<!-- 元素: <h1 id="teambition-网盘">，MDX 标题级别 1 -->
...
<!-- 元素: <h1 id="ads-adrive-design-system">，MDX 标题级别 1 -->

## ADS 架构

<!-- 元素: <h2 id="ads-架构">，MDX 标题级别 2 -->
